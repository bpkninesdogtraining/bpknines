...
const DogBoarding = ({ siteContent }) => {
  const footerRef = useRef(null);
  const { brand, dogboarding } = siteContent;
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (!prefersReducedMotion) {
        ambientTweens.push(gsap.to('.dogboarding-cta-dynamic', {
          duration: 1.05,
          repeat: -1,
          repeatDelay: 1.4,
          yoyo: true,
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                 ...
                 <Typography className="blog-heading" variant="body1" sx={{ color: 'text.secondary', textAlign: 'left', fontSize: { xs: '.9rem' },maxWidth: 680, marginLeft: 3 }}>
                  <ul style={{ listStyleType: 'none', paddingLeft: 1, marginTop: 0 }}>
                    Please bring the following upon dogboarding:
                      <li>✅ Complete and Updated Vaccination Records</li>
                      <li>✅ Dog Food for the entire training period</li>
                      <li>✅ Dog Shampoo (if necessary)</li>
                      <li>✅ Towel (if necessary)</li>
                  ...
                  <Box sx={{ justifySelf: 'start', width: '100%', maxWidth: 660, height: 610, borderRadius: 3, border: '1px solid rgba(31, 74, 59, 0.10)'}}>
                   <iframe
                    ...
                    id="inline-9GVtN9HyuZ0uu5M0TMlA" 
                    ...
                    data-form-name="Boarding - Client Information"
                    data-height="763"
                    data-layout-iframe-id="inline-9GVtN9HyuZ0uu5M0TMlA"
                    data-form-id="9GVtN9HyuZ0uu5M0TMlA"
                    title="Boarding - Client Information"
